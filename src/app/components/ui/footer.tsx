    ...
    <footer id="contact" className="relative z-10 mt-8 w-full overflow-hidden pt-16 pb-8 px-4 md:px-0">
      <style jsx global>{`
        .glass {
          ...
          background: radial-gradient(circle, var(--color-white) 0%, #ffdce64d 60%, var(--color-primary) 100%);
        ...
        .glass:where(.dark, .dark *) {
          ...
          background: radial-gradient(circle, #ffffff1a 0%, #1e00001a 60%, var(--color-primary) 100%) !important;
