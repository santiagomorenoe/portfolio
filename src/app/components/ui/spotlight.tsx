  ...
  return (
    ...
    >
      <motion.div
        ...
        className="pointer-events-none absolute bottom-0 left-0 z-0 h-screen w-screen"
      >
        <div
          style={{
      ...
      <motion.div
        ...
        className="pointer-events-none absolute bottom-0 right-0 z-40 h-screen w-screen"
      >
        <div
          style={{
            transform: `translateY(${translateY}px) rotate(45deg)`,
